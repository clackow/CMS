                    <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                GLOBAL $connection;
                                //find all categories
                                $query = 'SELECT * FROM comment ';//LIMIT 3可以只显示3个
                                ...
                                while($row = mysqli_fetch_assoc($select_comment)){
                                    ...
                                    */
                                    ...
                                    echo "<td><a onClick=\"javascript: return confirm('Are you sure you want be delete')\" href='comment.php?delete=$comment_id'>Delete</a></td>";//pid是一个新的变量，通过pid来确定post_id
